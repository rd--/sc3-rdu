...
-- It tracks down the buffer size from the input graph and so won't
-- work for external buffers.
--
-- > audition (out 0 spl3)
spl3 =
...
-- > spl4 10 (soundIn 4) -- error
spl4 b z = pv_splita 'α' (fft b z 0.5 0 1 0)
